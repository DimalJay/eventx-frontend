...
const tasks = [
  {
    title: "Confirm stage lighting cue",
    owner: "Production",
    due: "Today 2:30 PM",
    status: "In progress",
  },
  {
    title: "Publish post-session survey",
    owner: "Comms",
    due: "Today 4:00 PM",
    status: "Queued",
  },
  {
    title: "Finalize VIP escort list",
    owner: "Ops",
    due: "Today 5:00 PM",
    status: "Blocked",
  },
...
export default function EventOperationsSection() {
  return (
    <>
          ...
          {tasks.map((task) => (
            ...
            >
              <div>
                ...
                <p className="mt-1 text-sm text-black/60">{task.owner}</p>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-black/40">Due</p>
                <p className="mt-1 text-sm font-semibold text-black">{task.due}</p>
              </div>
